...
namespace Chess.ViewModels
{
    public class ApplicationViewModel : PropertyChangedBase
    {
        ...
        public ApplicationViewModel()
                                                //управляет состоянием игры, взаимодействует с моделью шахматной игры(Game),
                                                //а также обрабатывает различные события, такие как ход игроков, окончание игры, экспорт/импорт данных и т.д.
        {
